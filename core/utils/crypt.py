...
class Crypt:
    ...
    __key = (__key + settings.SECRET_KEY).encode()
...
""" encrypt = Crypt('The name ``Tuple`2`` is a valid .NET type name.')

encrypted_data = encrypt.encrypt("The name ``Tuple`2`` is a valid .NET type name.")
